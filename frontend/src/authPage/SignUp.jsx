            ...
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                ...
                <div className="w-full p-8 lg:w-1/2">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        ...
                        <span className="text-xs text-center text-gray-500 uppercase"> Sign Up with email</span>
                        <span className="border-b w-1/5 lg:w-1/4"></span>
                    </div>

                    <div className="mt-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2">Full Name</label>
                        <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full" type="text" placeholder="Enter your full name" />
                    </div>
                    ...
                    <div className="mt-4">
                        ...
                        <select className="bg-gray-200 text-gray-700 border border-gray-300 rounded py-2 px-4 block w-full">
